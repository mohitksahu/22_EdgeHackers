...
import { deletePlanet, renamePlanet } from '../services/sessionService';
...
const NewPlanet = () => {
  ...
  const handleRenameSubmit = () => {
    ...
    if (existingPlanet) {
      setRenameError('A planet with this name already exists.');
      return;
    }

    renamePlanet(renamingPlanet.id, trimmedName);
