...
class LlamaReasoner:
    ...
    def __new__(cls, model_path: Optional[str] = None):
        """Singleton pattern: only one instance of LlamaReasoner"""
    ...
    def __init__(self, model_path: Optional[str] = None):
        ...
        model_path = model_path or r"D:\Pluto\data\models\Llama-3.2-1B-Instruct-Q4_K_M-GGUF\llama-3.2-1b-instruct-q4_k_m.gguf"
